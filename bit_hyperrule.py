...
def get_schedule(dataset_size):
  if dataset_size < 20_000:
    # return [100, 200, 300, 400, 500] # base
    return [400, 800, 1200, 1600, 2000] # batch size : 128인 경우
  elif dataset_size < 500_000:
    return [500, 3000, 6000, 9000, 10000] # base
    # return [2000, 12000, 24000, 36000, 40000] # iteration upscale
  else:
    return [500, 6000, 12_000, 18_000, 20_000] # base
    # return [2000, 24000, 48_000, 72_000, 80_000] # iteration upscale
